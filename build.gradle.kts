plugins {
  ...
  id("io.bkbn.sourdough.library.jvm") version "0.9.1-SNAPSHOT" apply false
  id("io.bkbn.sourdough.application.jvm") version "0.9.1-SNAPSHOT" apply false
  id("io.bkbn.sourdough.root") version "0.9.1-SNAPSHOT"
